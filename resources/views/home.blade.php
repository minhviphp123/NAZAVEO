...
@section('content')
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border:1px solid; display:flex; align-items:center">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav" style="border:1px solid">
                    <ul class="navbar-nav me-auto ul-header">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="#">Mouse</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="#">Keyboard</a>
                        </li>
                    </ul>
                </div>
            </div>
